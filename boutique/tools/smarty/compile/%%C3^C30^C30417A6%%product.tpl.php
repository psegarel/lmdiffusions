<?php /* Smarty version 2.6.20, created on 2009-06-25 15:03:19
         compiled from /homez.120/peruk/www/boutique/themes/prestashop/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 2, false),array('modifier', 'html_entity_decode', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 7, false),array('modifier', 'floatval', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 8, false),array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 9, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 22, false),array('modifier', 'default', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 24, false),array('modifier', 'date_format', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 30, false),array('modifier', 'cat', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 40, false),array('modifier', 'addslashes', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 57, false),array('modifier', 'htmlspecialchars', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 99, false),array('modifier', 'truncate', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 318, false),array('modifier', 'strip_tags', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 321, false),array('modifier', 'stripslashes', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 377, false),array('function', 'l', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 47, false),array('function', 'math', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 95, false),array('function', 'convertPrice', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 161, false),array('function', 'displayWtPrice', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 324, false),array('function', 'counter', '/homez.120/peruk/www/boutique/themes/prestashop/product.tpl', 356, false),)), $this); ?>
...
<?php echo $this->_tpl_vars['product']->id; ?>
-<?php echo $this->_tpl_vars['image']['id_image']; ?>
-small.jpg" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['image']['legend'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
...
<div style="display:block; overflow:hidden;">
	<?php if (( ( $this->_tpl_vars['pdf'] ) || ( $this->_tpl_vars['swf'] ) )): ?><h2 class="product"><?php echo smartyTranslate(array('s' => 'Look SWF and/or Upload PDF'), $this);?>
</h2> <?php endif; ?>
	<?php if ($this->_tpl_vars['swf']): ?>	
	<div style="text-align:center; display:block; float:left; width:50%; margin-top:15px;">
	<?php $_from = $this->_tpl_vars['swf']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['flash']):
?>
	<p><a href="img/flash/<?php echo $this->_tpl_vars['flash']['id_flash']; ?>
.swf?keepThis=true&TB_iframe=true" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['flash']['legend'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" class="thickbox <?php if (($this->_foreach['thumbnails']['iteration'] <= 1)): ?>shown<?php endif; ?>">
	<img src="img/swf.gif" border="0"><p style="text-align: center;"><?php echo $this->_tpl_vars['flash']['legend']; ?>
</p></a>
	<?php endforeach; endif; unset($_from); ?>
	</div><?php endif; ?>	
	<?php if ($this->_tpl_vars['pdf']): ?>
	<div style="text-align:center; display:block; float:left; width:50%; margin-top:15px;">
		<?php $_from = $this->_tpl_vars['pdf']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['document']):
?>
		<p><a href="img/documents/<?php echo $this->_tpl_vars['document']['id_document']; ?>
.pdf" target="_blank"><img src="img/pdf.gif" border="0"><p style="text-align: center;"><?php echo $this->_tpl_vars['document']['legend']; ?>
</p></a><br>
		<?php endforeach; endif; unset($_from); ?>
	</div><?php endif; ?>
	</div>
...
-small.jpg" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['accessory']['legend'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /></a>
								<a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['accessoryLink'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
