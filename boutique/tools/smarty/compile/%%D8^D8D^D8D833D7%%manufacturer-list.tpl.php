<?php /* Smarty version 2.6.20, created on 2012-09-07 16:16:53
         compiled from /homez.120/peruk/www/boutique/themes/peruk/manufacturer-list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/themes/peruk/manufacturer-list.tpl', 1, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/themes/peruk/manufacturer-list.tpl', 20, false),array('modifier', 'truncate', '/homez.120/peruk/www/boutique/themes/peruk/manufacturer-list.tpl', 27, false),array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/peruk/manufacturer-list.tpl', 39, false),)), $this); ?>
...
"><?php endif; ?>
				...
				<?php if ($this->_tpl_vars['manufacturer']['nb_products'] > 0): ?><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['link']->getmanufacturerLink($this->_tpl_vars['manufacturer']['id_manufacturer'],$this->_tpl_vars['manufacturer']['link_rewrite']))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
"><?php endif; ?>
				<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['manufacturer']['description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 300) : smarty_modifier_truncate($_tmp, 300)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
