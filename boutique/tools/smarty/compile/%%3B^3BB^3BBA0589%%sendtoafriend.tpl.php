<?php /* Smarty version 2.6.20, created on 2012-08-01 14:03:59
         compiled from /homez.120/peruk/www/boutique/modules/sendtoafriend/sendtoafriend.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/modules/sendtoafriend/sendtoafriend.tpl', 1, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/modules/sendtoafriend/sendtoafriend.tpl', 23, false),array('modifier', 'stripslashes', '/homez.120/peruk/www/boutique/modules/sendtoafriend/sendtoafriend.tpl', 23, false),)), $this); ?>
...
-small.jpg" alt="" title="<?php echo $this->_tpl_vars['cover']['legend']; ?>
" /></a><br/>
				<a href="<?php echo $this->_tpl_vars['productLink']; ?>
...
<?php endif; ?>" />
			...
			<p>
				...
				<input type="text" id="friend-address" name="email" value="<?php if (isset ( $_POST['name'] )): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$_POST['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php endif; ?>" />
			</p>
