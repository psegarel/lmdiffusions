<?php /* Smarty version 2.6.20, created on 2014-06-25 11:00:55
         compiled from /WebDev/peruk/versions/www/boutique/themes/peruk/category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/WebDev/peruk/versions/www/boutique/themes/peruk/category.tpl', 8, false),array('modifier', 'intval', '/WebDev/peruk/versions/www/boutique/themes/peruk/category.tpl', 10, false),array('function', 'l', '/WebDev/peruk/versions/www/boutique/themes/peruk/category.tpl', 10, false),)), $this); ?>
...
<?php else: ?>default<?php endif; ?>-medium.jpg" alt="" />
				...
				<br />
				<a class="lien_categorie" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['link']->getCategoryLink($this->_tpl_vars['subcategory']['id_category'],$this->_tpl_vars['subcategory']['link_rewrite']))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['subcategory']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
  ...
  <?php if ($this->_tpl_vars['products'] && ! isset ( $this->_tpl_vars['subcategories'] )): ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
