<?php /* Smarty version 2.6.20, created on 2012-08-01 14:49:41
         compiled from /homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl', 14, false),array('function', 'convertPrice', '/homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl', 70, false),array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl', 62, false),array('modifier', 'sizeof', '/homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl', 62, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/themes/peruk/order-carrier.tpl', 66, false),)), $this); ?>
...
');">
<div class="transporteurs_container">
<?php if ($this->_tpl_vars['conditions']): ?>
	<div id="conditions_generales_ventes">
...
cms.php?id_cms=3" target="_blank"><?php echo smartyTranslate(array('s' => '(read)'), $this);?>
</a>
	</p>
	</div>
<?php endif; ?>
...
?>
				<tr class="<?php if (($this->_foreach['myLoop']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['myLoop']['iteration'] == $this->_foreach['myLoop']['total'])): ?>last_item<?php endif; ?> <?php if (($this->_foreach['myLoop']['iteration']-1) % 2): ?>alternate_item<?php else: ?>item<?php endif; ?>">
					<td align="center" class="carrier_action radio">
