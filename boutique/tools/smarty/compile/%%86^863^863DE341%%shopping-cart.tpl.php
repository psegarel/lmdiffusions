<?php /* Smarty version 2.6.20, created on 2012-08-01 14:50:43
         compiled from /homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 1, false),array('function', 'convertPrice', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 87, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 30, false),array('modifier', 'count', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 41, false),array('modifier', 'htmlentities', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 72, false),array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/peruk/shopping-cart.tpl', 147, false),)), $this); ?>
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std" cellspacing="0" cellpadding="0">
		<thead>
			<tr>
				<th class="cart_product first_item"><?php echo smartyTranslate(array('s' => ''), $this);?>
</th>
				<th class="cart_description item"><?php echo smartyTranslate(array('s' => 'Product'), $this);?>
</th>
				...
				<th class="cart_total last_item"><?php echo smartyTranslate(array('s' => 'Sous Total'), $this);?>
</th>
				<th class="trash"> </th>
			</tr>
		</thead>
...
" method="post" id="voucher">
							<p>
									<label for="discount_name"><?php echo smartyTranslate(array('s' => 'Vouchers'), $this);?>
 : </label>
...
<?php endif; ?>" />
								...
								<span class="submit"><input type="submit" name="submitDiscount" value="<?php echo smartyTranslate(array('s' => 'Add'), $this);?>
" class="button" /></span>
							</p>
						</form>
					<?php endif; ?>
			...
			<tr class="cart_total_product">
				<td colspan="4" class="price"><?php echo smartyTranslate(array('s' => 'Total products:'), $this);?>
</td>
				<td colspan="2" class="price"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['total_products_wt']), $this);?>
</td>
			</tr>
			-->
			<?php if ($this->_tpl_vars['total_discounts'] != 0): ?>
			<tr class="cart_total_voucher">
				<td colspan="4" class="price"><?php echo smartyTranslate(array('s' => 'Total vouchers:'), $this);?>
</td>
				<td colspan="2" class="price-discount"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['total_discounts']), $this);?>
</td>
			</tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['total_wrapping'] > 0): ?>
			<tr class="cart_total_voucher">
				<td colspan="4" class="price"><?php echo smartyTranslate(array('s' => 'Total gift-wrapping:'), $this);?>
</td>
				<td colspan="2" class="price-discount"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['total_wrapping']), $this);?>
</td>
			</tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['shippingCost'] > 0): ?>
			<tr class="cart_total_delivery">
				<td colspan="4" class="price"><?php echo smartyTranslate(array('s' => 'Total shipping:'), $this);?>
</td>
				<td colspan="2" class="price"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['shippingCost']), $this);?>
</td>
			</tr>
			<?php endif; ?>
			<tr class="cart_total_price">
				<td colspan="4" class="price"><?php echo smartyTranslate(array('s' => 'Total:'), $this);?>
</td>
				<td colspan="2" class="price"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['total_price']), $this);?>
</td>
			</tr>
			<?php if ($this->_tpl_vars['free_ship'] > 0): ?>
			<tr class="cart_free_shipping">
				<td colspan="4" class="price" style="white-space: normal;"><?php echo smartyTranslate(array('s' => 'Remaining amount to be added to your cart in order to obtain free shipping:'), $this);?>
</td>
				<td colspan="2" class="price"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['free_ship']), $this);?>
</td>
			</tr>
			<?php endif; ?>
		</tfoot>
