<?php /* Smarty version 2.6.20, created on 2012-08-02 18:22:10
         compiled from /homez.120/peruk/www/boutique/themes/peruk/address.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/peruk/address.tpl', 3, false),array('modifier', 'escape', '/homez.120/peruk/www/boutique/themes/peruk/address.tpl', 22, false),array('function', 'l', '/homez.120/peruk/www/boutique/themes/peruk/address.tpl', 16, false),)), $this); ?>
...
<?php endif; ?>" />
	...
	<p class="submit">
		<?php if (isset ( $this->_tpl_vars['id_address'] )): ?><input type="hidden" name="a" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['id_address'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
" /><?php endif; ?>
...
" class="button" />
	...
	<p class="champs_obligatoires"><sup>*</sup><?php echo smartyTranslate(array('s' => 'Required field'), $this);?>
</p>
</form>
</div>