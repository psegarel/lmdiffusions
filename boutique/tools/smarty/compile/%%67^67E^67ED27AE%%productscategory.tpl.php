<?php /* Smarty version 2.6.20, created on 2012-08-01 13:38:50
         compiled from /homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl', 5, false),array('function', 'math', '/homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl', 11, false),array('modifier', 'count', '/homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl', 11, false),array('modifier', 'htmlspecialchars', '/homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl', 14, false),array('modifier', 'truncate', '/homez.120/peruk/www/boutique/modules/productscategory/productscategory.tpl', 18, false),)), $this); ?>
<?php if (count ( $this->_tpl_vars['categoryProducts'] ) > 1): ?>
...
<?php echo $this->_tpl_vars['categoryProduct']['id_image']; ?>
-small.jpg" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" />
			</a><br/>
			<a href="<?php echo $this->_tpl_vars['link']->getProductLink($this->_tpl_vars['categoryProduct']['id_product'],$this->_tpl_vars['categoryProduct']['link_rewrite'],$this->_tpl_vars['categoryProduct']['category']); ?>
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
">
			<?php echo ((is_array($_tmp=$this->_tpl_vars['categoryProduct']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 15) : smarty_modifier_truncate($_tmp, 15)); ?>
