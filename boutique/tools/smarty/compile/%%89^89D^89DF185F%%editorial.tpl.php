<?php /* Smarty version 2.6.20, created on 2014-06-23 18:00:11
         compiled from /WebDev/peruk/versions/www/boutique/modules/editorial/editorial.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/WebDev/peruk/versions/www/boutique/modules/editorial/editorial.tpl', 3, false),array('modifier', 'stripslashes', '/WebDev/peruk/versions/www/boutique/modules/editorial/editorial.tpl', 3, false),)), $this); ?>
<!-- Module Editorial -->
...
<?php endif; ?> 
	...
	<?php if ($this->_tpl_vars['xml']->body->{(($_var=$this->_tpl_vars['paragraph']) && substr($_var,0,2)!='__') ? $_var : $this->trigger_error("cannot access property \"$_var\"")}): ?><div><?php echo ((is_array($_tmp=$this->_tpl_vars['xml']->body->{(($_var=$this->_tpl_vars['paragraph']) && substr($_var,0,2)!='__') ? $_var : $this->trigger_error("cannot access property \"$_var\"")})) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</div><?php endif; ?>
</div>
<!-- /Module Editorial -->