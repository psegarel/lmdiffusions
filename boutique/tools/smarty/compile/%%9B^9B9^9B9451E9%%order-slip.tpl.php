<?php /* Smarty version 2.6.20, created on 2012-08-01 14:23:08
         compiled from /homez.120/peruk/www/boutique/themes/peruk/order-slip.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homez.120/peruk/www/boutique/themes/peruk/order-slip.tpl', 1, false),array('function', 'dateFormat', '/homez.120/peruk/www/boutique/themes/peruk/order-slip.tpl', 23, false),array('modifier', 'string_format', '/homez.120/peruk/www/boutique/themes/peruk/order-slip.tpl', 21, false),array('modifier', 'intval', '/homez.120/peruk/www/boutique/themes/peruk/order-slip.tpl', 22, false),)), $this); ?>
...
<div class="block-center" id="block-history">
	...
	<table id="order-list" class="std" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<th class="history_link"><?php echo smartyTranslate(array('s' => 'Credit slip'), $this);?>
</th>
...
?>
			<tr class="<?php if (($this->_foreach['myLoop']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['myLoop']['iteration'] == $this->_foreach['myLoop']['total'])): ?>last_item<?php else: ?>item<?php endif; ?> <?php if (($this->_foreach['myLoop']['iteration']-1) % 2): ?>alternate_item<?php endif; ?>">
				<td class="history_link"><span class="color-myaccount"><?php echo smartyTranslate(array('s' => '#'), $this);?>
