...
if ($step = intval(Tools::getValue('ajaxProductTab')))
{
	...
	$switchArray = array(3 => 'displayFormAttributes', 4 => 'displayFormFeatures', 5 => 'displayFormCustomization', 6 => 'displayFormQuantityDiscount', 7 => 'displayFormDocument', 8 => 'displayFormFlash');
	$currentIndex = 'index.php?tab=AdminCatalog';
