...
<div id="primary_block">
	...
	<div id="pb-left-column">
		...
		<a href="img/flash/{$flash.id_flash}.swf?keepThis=true&TB_iframe=true" title="{$flash.legend|htmlspecialchars}" class="thickbox{if $smarty.foreach.thumbnails.first}shown{/if}">

		<img src="img/swf.gif" border="0" />

		<p style="text-align: center;">{$flash.legend}</p>
