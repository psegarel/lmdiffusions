...
{if $conditions}
	...
	<p class="checkbox">
		...
		<label for="cgv">{l s='I agree with the terms of service and I adhere to them unconditionally.'}</label> <a href="{$base_dir}cms.php?id_cms=3" target="_blank">{l s='(read)'}</a>
	</p>
	</div>
{/if}
