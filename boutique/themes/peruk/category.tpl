...
{/if}
	...
	<div id="subcategories">
		...
		{foreach from=$subcategories item=subcategory}
			<li>
				...
				<br />
				<a class="lien_categorie" href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'htmlall':'UTF-8'}">{$subcategory.name|escape:'htmlall':'UTF-8'}</a>
			</li>
		{/foreach}
		</ul>
		<br class="clear"/>
  ...
  {if $products and !isset($subcategories)}
