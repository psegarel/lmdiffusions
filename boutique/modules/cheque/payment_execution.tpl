...
<form action="{$this_path_ssl}validation.php" method="post">
	...
	<p>
		{if $currencies|@count > 1}
			...
			<br />	<br />
			<span class="instructions_cheque">{l s='Choose one of the following:' mod='cheque'}
	...
	<p>
		<span class="instructions_cheque">{l s='Cheque owner and address information will be displayed on the next page.' mod='cheque'}</span>
		<br />
