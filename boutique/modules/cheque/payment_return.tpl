{if $status == 'ok'}
	<h3 class="commande_finie">{l s='Your order on' mod='cheque'} <span class="bold">{$shop_name}</span> {l s='is complete.' mod='cheque'}</h3>
	<p>
		...
		<br /><br />- {l s='mail to' mod='cheque'} : <br /><br /> <span class="bold">{if $chequeAddress}{$chequeAddress}{else}___________{/if}</span>
