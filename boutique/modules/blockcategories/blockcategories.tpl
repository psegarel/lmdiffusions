...
<div id="categories_block_left" class="block">
    {foreach from=$blockCategTree.children item=cat name=blockCategTree}
    	<h4><a href="{$cat.link|escape:htmlall:'UTF-8'}"class="selected" title="{$cat.desc|escape:htmlall:'UTF-8'}">{$cat.name|escape:htmlall:'UTF-8'}</a></h4>

       {if $cat.children|@count gt 0}
